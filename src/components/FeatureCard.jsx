...
export const FeatureCard = ({image,description,num,title,delay}) => {
  return (
    <div data-aos="fade-down" data-aos-delay={delay} data-aos-anchor-placement="center-bottom" className='bg-amber-200 rounded-md text-center w-52 px-5 py-2'>
        <p className='text-6xl font-black tracking-tighter'>{num}</p>
